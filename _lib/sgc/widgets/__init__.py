...
Widgets:
  ...
  :py:class:`Switch<switch.Switch>`: Switch widget.
...
Composite widgets:
  :py:class:`DialogSaveQuit<composite.dialogs.DialogSaveQuit>`: Dialog asking the user if they want to save their work when quitting.
